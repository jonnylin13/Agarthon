...
(function(d, e) {
    function Jb() {
        ...
        ab();
        setInterval(ab, 18E4);
        J = Fa = document.getElementById("canvas");
        f = J.getContext("2d");
        ...
        d.onkeydown = function(n) {
            32 != n.keyCode || a || (ba(), K(17), a = !0);
            81 != n.keyCode || b || (K(18), b = !0);
            87 != n.keyCode || c || (ba(), K(21), c = !0);
            27 == n.keyCode && na(300)
        };
    ...
    function ab() {
        null == ra && (ra = {}, e("#region").children().each(function() {
            var a = e(this),
                b = a.val();
            b && (ra[b] = a.text())
        }));
        e.get("http://m.agar.io/info", function(a) {
            ...
            for (c in b) e('#region option[value="' + c + '"]').text(ra[c] + " (" + b[c] + " players)")
        }, "json")
    }
    ...
    function oa(a) {
        a && a != y && (e("#region").val() != a && e("#region").val(a), y = d.localStorage.location = a, e(".region-message").hide(), e(".region-message." + a).show(), e(".btn-needs-server").prop("disabled", !1), Ea && L())
    }

    function na(a) {
        da || U || (e("#adsBottom").show(), G = null, jb(d.aa), 1E3 > a && (s = 1), da = !0, e("#mainPanel").show(), 0 < a ? e("#overlays").fadeIn(a) : e("#overlays").show())
    }
    ...
    function jb(a) {
        d.googletag && d.googletag.cmd.push(function() {
            Ia && (Ia = !1, setTimeout(function() {
                Ia = !0
            }, 6E4 * Mb), d.googletag && d.googletag.pubads && d.googletag.pubads().refresh && d.googletag.pubads().refresh(a))
        })
    }
    ...
    function kb() {
        ...
        e.ajax("http://m.agar.io/findServer", {
            ...
            success: function(b) {
                a == Ha && (b.alert && alert(b.alert), Ja("ws://" + b.ip, b.token))
            },
            dataType: "json",
            method: "POST",
            cache: !1,
    ...
    function Qb(a, b) {
        ...
        for (var f = 0; f < p; ++f) {
            ...
            b += 8;
            C && k && (k.R(), k.o = k.x, k.p = k.y, k.n = k.size, k.C = C.x, k.D = C.y, k.m = k.size, k.K = E, Sb(C, k))
        }
        for (f = 0;;) {
            p = a.getUint32(b, !0);
            b += 4;
            ...
            var s = c(),
                m = null;
            H.hasOwnProperty(p) ? (m = H[p], m.J(), m.o = m.x, m.p = m.y, m.n = m.size, m.color = I) : (m = new Y(p, C, k, g, I, s), v.push(m), H[p] = m, m.ia = C, m.ja = k);
            m.f = l;
            m.j = q;
            m.C = C;
            m.D = k;
            ...
            m.T = R;
            m.V = r;
            s && m.t(s); - 1 != z.indexOf(p) && -1 == h.indexOf(m) && (h.push(m), 1 == h.length && (t = m.x, u = m.y, pb(), document.getElementById("overlays").style.display = "none",
                x = [], Pa = 0, Qa = h[0].color, Ra = !0, qb = Date.now(), S = Sa = Ta = 0))
        }
        C = a.getUint32(b, !0);
        b += 4;
        for (f = 0; f < C; f++) p = a.getUint32(b, !0), b += 4, m = H[p], null != m && m.R();
        Oa && 0 == h.length && (rb = Date.now(), Ra = !1, da || U || (sb ? (jb(d.ab), Ub(), U = !0, e("#overlays").fadeIn(3E3), e("#stats").show()) : na(3E3)))
    }
    ...
    function ba() {
        if (Z()) {
            var a = la - l / 2,
                b = ma - q / 2;
            64 > a * a + b * b || .01 > Math.abs(vb - pa) &&
                .01 > Math.abs(wb - qa) || (vb = pa, wb = qa, a = P(21), a.setUint8(0, 16), a.setFloat64(1, pa, !0), a.setFloat64(9, qa, !0), a.setUint32(17, 0, !0), Q(a))
        }
    }
    ...
    function xb() {
        ...
        if (0 < h.length) {
            Vb();
            for (var c = a = 0, d = 0; d < h.length; d++) h[d].J(), a += h[d].x / h.length, c += h[d].y / h.length;
            ha = a;
            ia = c;
            ja = g;
            t = (t + a) / 2;
            u = (u + c) / 2
        } else t = (29 * t + ha) / 30, u = (29 * u + ia) / 30, g = (9 * g + ja * yb()) / 10;
        Kb();
        Ga();
        Va || f.clearRect(0, 0, l, q);
        Va ? (f.fillStyle = za ? "#111111" : "#F2FBFF", f.globalAlpha = .05, f.fillRect(0, 0, l, q), f.globalAlpha = 1) : Xb();
        v.sort(function(a, b) {
        ...
        if (Na) {
            ...
            f.globalAlpha = .5;
            f.beginPath();
            for (d = 0; d < h.length; d++) f.moveTo(h[d].x, h[d].y), f.lineTo(ta, ua);
            f.stroke();
            f.restore()
        }
        f.restore();
        ...
        O = Math.max(O, zb());
        0 != O && (null == Aa && (Aa = new Ba(24, "#FFFFFF")), Aa.u(fa("score") + ": " + ~~(O / 100)), c = Aa.F(), a = c.width, f.globalAlpha = .2, f.fillStyle = "#000000", f.fillRect(10, q - 10 - 24 -
        ...
        1 < F && (F = 1);
        b = E - Ab;
        !Z() || da || U ? (s += b / 2E3, 1 < s && (s = 1)) : (s -= b / 300, 0 > s && (s = 0));
        0 < s && (f.fillStyle = "#000000", f.globalAlpha = .5 * s, f.fillRect(0, 0, l, q), f.globalAlpha = 1);
        Ab = E
    }

    function Xb() {
        f.fillStyle = za ? "#111111" : "#F2FBFF";
        f.fillRect(0, 0, l, q);
        f.save();
        f.strokeStyle = za ? "#AAAAAA" : "#000000";
        f.globalAlpha = .2 * g;
        for (var a = l / g, b = q / g, c = (-t + a / 2) % 50; c < a; c += 50) f.beginPath(), f.moveTo(c * g - .5, 0), f.lineTo(c *
            g - .5, b * g), f.stroke();
    ...
    function nb() {
        ...
        if (null != B || 0 != w.length)
            if (null != B || Ca) {
                ...
                if (null == B)
                    for (a.font = "20px Ubuntu", b = 0; b < w.length; ++b) c = w[b].name || fa("unnamed_cell"), Ca || (c = fa("unnamed_cell")), -1 != z.indexOf(w[b].id) ? (h[0].name && (c = h[0].name), a.fillStyle = "#FFAAAA") : a.fillStyle = "#FFFFFF", c = b + 1 + ". " + c, a.fillText(c, 100 - a.measureText(c).width / 2, 70 + 24 * b);
                else
    ...
    function $b(a) {
        for (var b = a.length, c, d; 0 < b;) d = Math.floor(Math.random() * b),
    ...
    function X(a, b) {
        ...
        if (null == b && d.localStorage[T]) {
            var n = JSON.parse(d.localStorage[T]);
            n.xp = a.e;
            n.xpNeeded = a.c;
            n.level = a.d;
            d.localStorage[T] = JSON.stringify(n)
        }
        if (c) {
        ...
        } else e(".agario-profile-panel .progress-bar-star").text(a.d), e(".agario-exp-bar .progress-bar-text").text(a.e + "/" + a.c + " XP"), e(".agario-exp-bar .progress-bar").css("width", (88 * a.e / a.c).toFixed(2) + "%"), b &&
            b()
    }

    function Bb(a) {
        "string" == typeof a && (a = JSON.parse(a));
        Date.now() + 18E5 > a.expires ? e("#helloContainer").attr("data-logged-in", "0") : (d.localStorage[T] = JSON.stringify(a), D = a.authToken, e(".agario-profile-name").text(a.name), mb(), X({
            e: a.xp,
            c: a.xpNeeded,
            d: a.level
    ...
    function Ub() {
        e(".stats-food-eaten").text(Pa);
        e(".stats-time-alive").text(Cb((rb - qb) / 1E3));
        e(".stats-leaderboard-time").text(Cb(Ta));
        e(".stats-highest-mass").text(~~(O / 100));
        e(".stats-cells-eaten").text(Sa);
    ...
    if (!d.agarioNoInit) {
        var Db = d.location.protocol,
            lb = "https:" == Db;
        if (lb && -1 == d.location.search.indexOf("fb")) d.location.href = "http://agar.io/";
        else {
            var Da = d.navigator.userAgent;
            if (-1 != Da.indexOf("Android")) d.ga &&
                d.ga("send", "event", "MobileRedirect", "PlayStore"), setTimeout(function() {
                    d.location.href = "https://play.google.com/store/apps/details?id=com.miniclip.agar.io"
                }, 1E3);
            else if (-1 != Da.indexOf("iPhone") || -1 != Da.indexOf("iPad") || -1 != Da.indexOf("iPod")) d.ga && d.ga("send", "event", "MobileRedirect", "AppStore"), setTimeout(function() {
                d.location.href = "https://itunes.apple.com/app/agar.io/id995999703?mt=8&at=1l3vajp"
            }, 1E3);
            else {
                var Fa, f, J, l, q, ca = null,
                    r = null,
                    t = 0,
                    u = 0,
                    z = [],
                    ...
                    ua = 0,
                    Gb = 0,
                    Zb = ["#333333", "#FF3333", "#33FF33", "#3333FF"],
                    Va = !1,
                    ga = !1,
                    ob = 0,
                    D = null,
                ...
                if ("undefined" == typeof console || "undefined" == typeof DataView || "undefined" == typeof WebSocket || null == Hb || null == Hb.getContext || null == d.localStorage) alert("You browser does not support this game, we recommend you to use Firefox to play this");
                else {
                    var ra = null;
                    ...
                    d.setGameMode = function(a) {
                        a != V && (":party" == V && e("#helloContainer").attr("data-party-state", "0"), ea(a), ":party" != a && L())
                    };
                    d.setAcid = function(a) {
                        Va = a
                    };
                    null != d.localStorage && (null == d.localStorage.AB9 && (d.localStorage.AB9 = 0 + ~~(100 * Math.random())), Gb = +d.localStorage.AB9, d.ABGroup = Gb);
                    e.get(Db + "//gc.agar.io", function(a) {
                        var b = a.split(" ");
                        a = b[0];
                        b = b[1] || ""; - 1 == ["UA"].indexOf(a) && Ib.push("ussr");
                        ka.hasOwnProperty(a) && ("string" == typeof ka[a] ? y || oa(ka[a]) : ka[a].hasOwnProperty(b) && (y || oa(ka[a][b])))
                    }, "text");
                    var Ia = !0,
                        Mb = 0,
                        ka = {
                        ...
                        eb = function() {
                            ...
                            return function() {
                                ...
                                var c = Date.now(),
                                    e = c - a;
                                e > b && (a = c - e % b, !Z() ||
                                    240 > Date.now() - ob ? xb() : console.warn("Skipping draw"), cc())
                            }
                        }(),
                        $ = {},
                        Ib = "poland;usa;china;russia;canada;australia;spain;brazil;germany;ukraine;france;sweden;chaplin;north korea;south korea;japan;united kingdom;earth;greece;latvia;lithuania;estonia;finland;norway;cia;maldivas;austria;nigeria;reddit;yaranaika;confederate;9gag;indiana;4chan;italy;bulgaria;tumblr;2ch.hk;hong kong;portugal;jamaica;german empire;mexico;sanik;switzerland;croatia;chile;indonesia;bangladesh;thailand;iran;iraq;peru;moon;botswana;bosnia;netherlands;european union;taiwan;pakistan;hungary;satanist;qing dynasty;matriarchy;patriarchy;feminism;ireland;texas;facepunch;prodota;cambodia;steam;piccolo;ea;india;kc;denmark;quebec;ayy lmao;sealand;bait;tsarist russia;origin;vinesauce;stalin;belgium;luxembourg;stussy;prussia;8ch;argentina;scotland;sir;romania;belarus;wojak;doge;nasa;byzantium;imperial japan;french kingdom;somalia;turkey;mars;pokerface;8;irs;receita federal;facebook;putin;merkel;tsipras;obama;kim jong-un;dilma;hollande;berlusconi;cameron;clinton;hillary;venezuela;blatter;chavez;cuba;fidel;merkel;palin;queen;boris;bush;trump".split(";"),
                    ...
                    Y.prototype = {
                        ...
                        R: function() {
                            ...
                            delete H[this.id];
                            a = h.indexOf(this); - 1 != a && (Oa = !0, h.splice(a, 1));
                        ...
                        t: function(a) {
                            if (this.name = a) null == this.k ? this.k = new Ba(this.i(), "#FFFFFF", !0, "#000000") : this.k.G(this.i()), this.k.u(this.name)
                        },
                        Q: function() {
                            ...
                            for (0 == this.a.length && 0 < a && this.a.push(new Xa(this, this.x, this.y, this.size, Math.random() - .5)); this.a.length < a;) b = ~~(Math.random() * this.a.length), b = this.a[b], this.a.push(new Xa(this,
                                b.x, b.y, b.g, b.b))
                        },
                        B: function() {
                            var a = 10;
                        ...
                        da: function() {
                            ...
                            for (var f = this, h = this.f ? 0 : (this.id / 1E3 + E / 1E4) % (2 * Math.PI), c = 0; c < b; ++c) {
                                ...
                                if (15 <
                                    ...
                                    !l && (a[c].x < va || a[c].y < wa || a[c].x > xa || a[c].y > ya) && (l = !0);
                        ...
                        s: function(a) {
                            if (this.H()) {
                                ...
                                !this.j && Eb && ":teams" != V ? (d = this.V, null == d ? d = null : ":" == d[0] ? (aa.hasOwnProperty(d) || (aa[d] = new Image, aa[d].src = d.slice(1)), d = 0 != aa[d].width && aa[d].complete ? aa[d] : null) : d = null, d || (-1 != Ib.indexOf(c) ? ($.hasOwnProperty(c) || ($[c] = new Image, $[c].src = "skins/" + c + ".png"), d = 0 != $[c].width && $[c].complete ? $[c] : null) : d = null)) : d = null;
                                e = d;
                                b || a.stroke();
                                a.fill();
                                ...
                                d = -1 != h.indexOf(this);
                                b = ~~this.y;
                                if (0 != this.id && (Ca || d) && this.name && this.k && (null == e || -1 == dc.indexOf(c))) {
                                    e = this.k;
                                    e.u(this.name);
                                    e.G(this.i());
                                ...
                                0 < this.id && Fb && (d || 0 == h.length && (!this.f || this.j) && 20 < this.size) && (null == this.I && (this.I = new Ba(this.i() / 2, "#FFFFFF", !0, "#000000")),
                    ...
                    Ba.prototype = {
                        ...
                        F: function() {
                            null == this.l && (this.l =
                                document.createElement("canvas"), this.N = this.l.getContext("2d"));
                            if (this.h) {
                                this.h = !1;
                                var a = this.l,
                                    b = this.N,
                    ...
                    var T = "loginCache3";
                    e(function() {
                        +d.localStorage.wannaLogin && (d.localStorage[T] && Bb(d.localStorage[T]), d.localStorage.fbPictureCache && e(".agario-profile-picture").attr("src", d.localStorage.fbPictureCache))
                    });
                    ...
                    d.fbAsyncInit = function() {
                        ...
                        d.FB.Event.subscribe("auth.statusChange", function(b) {
                            +d.localStorage.wannaLogin && ("connected" == b.status ? Ya(b) : a())
                        });
                        d.facebookLogin =
                            a
                    };
...
if (window.location.search.indexOf('fb') != -1) {
    ...
    if (window.ABGroup < 78) {
        dfp = '/53945695/agar/300x250_CRL';
        dfpStats = '/53945695/agar/300x250_CRL_stats';
    } else if (window.ABGroup < 80) {
        dfp = '/53945695/agar/300x250_CRM';
        dfpStats = '/53945695/agar/300x250_CRM_stats';
    } else {
